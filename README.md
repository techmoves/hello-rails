...
**Hello Rails ** Implements connection: Rails back-end to React front-end, displaying random greeting message.
...
```
  git clone : https://github.com/techmoves/hello-rails.git
...
Feel free to check the [issues page](https://github.com/techmoves/hello-rails/issues).
...
This project is [MIT](https://github.com/techmoves/hello-rails/blob/dev/LICENSE) licensed.
